...
1. Your service should point to the deployment by using a `version` or `app.kubernetes.io/version` selector, pointing to the corresponding label in the deployment
